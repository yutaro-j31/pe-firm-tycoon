...
try{
  ...
  for(const f of ['engine-patch-v63-1.js','engine-patch-v63-2.js','engine-patch-v63-3.js','engine-patch-v63-4.js','engine-patch-v63-run.js','engine-patch-v63-final-1.js','engine-patch-v63-final-2.js','engine-patch-v63-final-3.js','engine-patch-v63-final-run.js'])await loadScript(f);
  ...
  if(typeof window.__patchPEEngineV63Final!=='function')throw new Error('v6.3 final balance patch loader is missing');
  js=window.__patchPEEngineV63Final(js);
  (0,eval)(js);
